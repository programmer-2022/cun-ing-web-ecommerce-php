...
<body id="page-top">
                        ...
                        <div class="col-md-3">
                            <div class="card bg-primary text-white">
                                <div class="card-body">
                                    ...
                                    <a href="admin-products.php" class="btn btn-light">Products Managment</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body">
                                    ...
                                    <a href="admin-users.php" class="btn btn-light">Users Managment</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body">
                                    ...
                                    <a href="admin-messages.php" class="btn btn-light">Messages Managment</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
    ...
    <!-- Custom scripts for all pages-->
    <script src="js/sb-admin-2"></script>
